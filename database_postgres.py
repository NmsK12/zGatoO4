#!/usr/bin/env python3
"""
Base de datos PostgreSQL para API Keys del servidor de árbol genealógico
"""
import psycopg2
import os
...
DATABASE_URL = os.getenv('DATABASE_URL', 'postgresql://postgres:qzvXzemtXvpyZsqIMZaQJrMdmqvrgckT@crossover.proxy.rlwy.net:57036/railway')
