...
# URL de conexión a PostgreSQL del servidor AG
DATABASE_URL = 'postgresql://postgres:qzvXzemtXvpyZsqIMZaQJrMdmqvrgckT@crossover.proxy.rlwy.net:57036/railway'

def fix_database():
    """Arregla la base de datos del servidor AG"""
    conn = None
    try:
